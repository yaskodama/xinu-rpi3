...
\paragraph{N-Queens 計算カーネル (C, Pi 3 側)} \hfill
\texttt{apps/abcl\_program.c:1505-1531}
\lstinputlisting[firstline=1505,lastline=1531, firstnumber=1505, language=C]{/Users/kodamay/projects/xinu-raz/xinu/apps/abcl_program.c}

\paragraph{Worker.compute\_nq アクターメソッド} \hfill
\texttt{apps/abcl\_program.c:1400-1432}
\lstinputlisting[firstline=1400,lastline=1432, firstnumber=1400, language=C]{/Users/kodamay/projects/xinu-raz/xinu/apps/abcl_program.c}

\paragraph{Dispatcher.submit\_nq (Round-robin 振分け)} \hfill
\texttt{apps/abcl\_program.c:1118-1147}
\lstinputlisting[firstline=1118,lastline=1147, firstnumber=1118, language=C]{/Users/kodamay/projects/xinu-raz/xinu/apps/abcl_program.c}

\paragraph{/api/loadbal/nqueens HTTP ルート} \hfill
\texttt{apps/webactor.c:1422-1517}
\lstinputlisting[firstline=1422,lastline=1517, firstnumber=1422, language=C]{/Users/kodamay/projects/xinu-raz/xinu/apps/webactor.c}

\paragraph{Mac 側 N-Queens 参照実装 (Python)} \hfill
...
\paragraph{Mac 側 Pi 3 ポーリング (並列)} \hfill
