// apps/gfont8x8.c — 8x8 ASCII bitmap font (ported verbatim from xinu-rpi5).
//
...
//
// Guarded for arm-rpi3 only so other platforms build this as an empty
// translation unit (no duplicate-symbol clash with their own fonts).
