...
/* 1 if any window stacked above w overlaps it — used to skip incremental
 * content draws of a covered window so its content can't bleed over the
 * window(s) on top (e.g. the live AIPL actor monitor text). */
static int wm_is_covered(window_t *w)
{
    for (window_t *p = w->next; p; p = p->next)
        if (p->x < w->x + w->width && p->x + p->width > w->x &&
            p->y < w->y + w->height && p->y + p->height > w->y)
            return 1;
    return 0;
}
        ...
        if (g_need_full) {
            ...
            for (window_t *w = wm_head; w; w = w->next) {
                if (!seen_done) {
                    ...
                    /* skip incremental redraw of a covered window (no bleed over
                     * windows on top); it repaints on the next full repaint. */
                    if (w->draw_content && !wm_is_covered(w)) w->draw_content(w, frame);
                } else {
                    draw_chrome(w);
                    g_force_redraw = 1;
                    if (w->draw_content) w->draw_content(w, frame);
...
/* Piece kanji bitmaps (28x28, 1bpp), rendered from Hiragino on the Mac. */
static const unsigned char sg_kanji[16][112] = {
  { 0 },
  /* 1 歩 */ {0x00,0x00,0x00,0x00,0x00,0x07,0x00,0x00,0x00,0x07,0x00,0x00,0x03,0x87,0x02,0x00,0x03,0x87,0xff,0x00,0x03,0x87,0xff,0x00,0x03,0x87,0x00,0x00,0x03,0x87,0x00,0x00,0x1f,0xff,0xff,0x80,0x3f,0xff,0xff,0xc0,0x3f,0xff,0xff,0xc0,0x00,0x07,0x00,0x00,0x01,0xc7,0x38,0x00,0x03,0xc7,0x3c,0x00,0x03,0x87,0x1e,0x00,0x0f,0x07,0x0f,0x80,0x1e,0x3f,0x17,0xc0,0x3c,0x3e,0x3b,0x80,0x18,0x3e,0x78,0x80,0x00,0x01,0xf0,0x00,0x00,0x03,0xe0,0x00,0x00,0x1f,0x80,0x00,0x0f,0xff,0x00,0x00,0x0f,0xfc,0x00,0x00,0x07,0xe0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
  /* 2 香 */ {0x00,0x00,0x00,0x00,0x00,0x03,0xfc,0x00,0x0f,0xff,0xfe,0x00,0x07,0xff,0xf0,0x00,0x00,0x0e,0x00,0x00,0x00,0x0e,0x00,0x00,0x1f,0xff,0xff,0x80,0x1f,0xff,0xff,0x80,0x18,0x7f,0xe1,0x80,0x00,0x7f,0xe0,0x00,0x00,0xee,0xf0,0x00,0x03,0xee,0x7c,0x00,0x0f,0x8e,0x1f,0x80,0x3f,0x80,0x1f,0xc0,0x1f,0xff,0xff,0x80,0x03,0xff,0xfc,0x80,0x03,0x80,0x1c,0x00,0x03,0x80,0x1c,0x00,0x03,0xff,0xfc,0x00,0x03,0xff,0xfc,0x00,0x03,0x80,0x1c,0x00,0x03,0x80,0x1c,0x00,0x03,0xff,0xfc,0x00,0x03,0xff,0xfc,0x00,0x03,0x80,0x1c,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
  /* 3 桂 */ {0x00,0x00,0x00,0x00,0x03,0x00,0xe0,0x00,0x03,0x00,0xe0,0x00,0x03,0x00,0xe0,0x00,0x03,0x1f,0xff,0x80,0x1f,0xdf,0xff,0x80,0x3f,0xe8,0xf1,0x00,0x3f,0xe0,0xe0,0x00,0x07,0x80,0xe0,0x00,0x07,0x80,0xe0,0x00,0x07,0xdf,0xff,0xc0,0x0f,0xff,0xff,0xc0,0x0f,0xfc,0x03,0x80,0x1f,0x60,0xe0,0x00,0x1f,0x40,0xe0,0x00,0x3b,0x00,0xe0,0x00,0x3b,0x1f,0xff,0x80,0x33,0x1f,0xff,0x80,0x13,0x1c,0xf3,0x80,0x03,0x00,0xe0,0x00,0x03,0x00,0xe0,0x00,0x03,0x00,0xe0,0x00,0x03,0x3f,0xff,0xc0,0x03,0x3f,0xff,0xc0,0x03,0x3f,0xff,0xc0,0x03,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
  /*