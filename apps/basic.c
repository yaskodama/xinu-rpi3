...
static const char *S_flight[] = {
    ...
    "2230 LINE (430, 250)-(430, 158), WHITE",
    "2240 LINE (462, 250)-(462, 158), WHITE",
    "2250 LINE (425, 158)-(467, 158), WHITE",
    "2260 LINE (446, 158)-(446, 138), CYAN",
    "2270 BMR = T / 560",
    "2280 BMX = 40 + BMR * 370",
    "2290 BMY = 235 - 120 * SIN(BMR * 3.14159)",
    "2300 BMD = 1",
    "2310 IF T >= 280 THEN BMD = -1",
    "2320 LINE (BMX - 16 * BMD, BMY)-(BMX + 16 * BMD, BMY), CYAN",
