...
static const char *S_flight[] = {
    ...
    "60 GOSUB *SCENE",
    "70 DIR = 1",
    "80 IF T < 50 THEN PX = 30 + T * 5.2 : PY = 238 : GOTO *DP",
    "90 IF T < 100 THEN PX = 290 + (T - 50) * 2.8 : PY = 238 - (T - 50) * 2.76 : GOTO *DP",
    "100 IF T < 150 THEN PX = 430 + (T - 100) * 1.4 : PY = 100 : GOTO *DP",
    "110 IF T < 175 THEN PX = 500 : PY = 100 : GOTO *DP",
    "120 DIR = -1",
    "130 IF T < 245 THEN PX = 500 - (T - 175) * 5.85 : PY = 100 : GOTO *DP",
    "140 IF T < 295 THEN PX = 90 - (T - 245) * 1 : PY = 100 + (T - 245) * 2.76 : GOTO *DP",
    "150 PX = 40 : PY = 238",
    "160 *DP",
    "170 GOSUB *PLANE",
    "180 T = T + 3",
    "190 IF T < 330 THEN GOTO 210",
    "200 T = 0",
    "210 WAIT 0.02",
    "220 GOTO *FRAME",
    "230 *SCENE",
    "240 LINE (20, 252)-(540, 252), GREEN",
    "250 LINE (30, 248)-(300, 248), WHITE",
    "260 LINE (430, 252)-(430, 160), WHITE",
    "270 LINE (462, 252)-(462, 160), WHITE",
    "280 LINE (425, 160)-(467, 160), WHITE",
    "290 LINE (425, 160)-(425, 138), WHITE",
    "300 LINE (467, 160)-(467, 138), WHITE",
    "310 LINE (425, 138)-(446, 126), WHITE",
    "320 LINE (446, 126)-(467, 138), WHITE",
    "330 LINE (446, 126)-(446, 110), CYAN",
    "340 RETURN",
    "350 *PLANE",
    "360 LINE (PX - 16 * DIR, PY)-(PX + 16 * DIR, PY), CYAN",
    "370 LINE (PX + 16 * DIR, PY)-(PX + 9 * DIR, PY - 4), CYAN",
    "380 LINE (PX - 16 * DIR, PY)-(PX - 21 * DIR, PY - 10), CYAN",
    "390 LINE (PX - 5 * DIR, PY)-(PX - 12 * DIR, PY + 7), CYAN",
    "400 LINE (PX - 5 * DIR, PY)-(PX + 3 * DIR, PY + 7), CYAN",
    "410 RETURN",
};
